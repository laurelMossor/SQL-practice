...
COPY public.grades (id, title, student_github, grade) FROM stdin;
1	Markov	jhacks	10
2	Blocky	jhacks	2
3	Markov	sdevelops	50
4	Blocky	sdevelops	100
\.
...
3	Faker	Fake Data	100
4	Capstone	The Big One	10000000
5	World Dashboard	Information from around the world	2
\.
